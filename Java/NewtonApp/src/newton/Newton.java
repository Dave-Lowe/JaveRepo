...
public class Newton extends Frame implements Runnable, WindowListener, MouseListener
{
...
// END GENERATED CODE
	...
	*/
	...
	public Newton() 
	{
		...
		/* have to explicitly call start in an */
	...
	public String getParameter(String key, String def) 
	{
		return isStandalone ? System.getProperty(key, def) :
			(getParameter(key, def) != null ? getParameter(key, def) : def);
	}
